...
setup(
    ...
    # la version du code
    version=openFile_pac.__version__,
    ...
    description="Cette lib permet de préparer le travail pour l'ouverture et le traitemant des fichiers.",
    ...
    url='https://poltergeist42-mylib.github.io/openFile/',
